                                    ...
                                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                                        {[
                                            ...
                                            <button
                                                key={p.id}
                                                onClick={() => {
                                                    props.handleProviderChange(p.id);
                                                    if (p.id === 'local') {
                                                        props.setLlmFormEndpoint('http://localhost:11434/v1');
                                                        props.setLlmFormModel('llama3.2:3b');
                                                        props.setLlmFormKey('ollama');
                                                    }
                                                }}
                                                style={{
                                            ...
                                            >{p.id === 'local' ? 'Ollama / Local (Custom)' : p.name}</button>
                                        ))}
                                    </div>
                                </div>
